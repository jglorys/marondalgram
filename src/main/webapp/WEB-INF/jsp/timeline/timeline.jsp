		...
		<div class="timeline-box my-5">
			...
			<div class="card border rounded mt-3 bg-light">
				...
				<div class="p-2 d-flex justify-content-between">
					<span class="font-weight-bold">jglorys</span>
				...
				<div class="card-img">
					<img
						src="https://cdn.pixabay.com/photo/2020/04/17/12/28/pool-5055009__480.jpg"
						class="w-100">
				</div>
				...
				<div class="card-post m-3">
					<span class="font-weight-bold">marobiana</span> <span> 비지도
						학습을 해본 결과입니다.</span>
				</div>
				<%-- 댓글(Comment) --%>
